...
public class Win32SpoolMonitor {
    ...
    public Win32SpoolMonitor() {
        ...
        String pPrinterName = "Send To OneNote 2016";
        ...
        if (chgObject != null) {
            Winspool.PRINTER_INFO_4[] printerInfo = WinspoolUtil.getPrinterInfo4();
            LOG.info(Arrays.toString(printerInfo));
            while (true) {
                ...
                if (fcnreturn) {
                    ...
                    for (JOB_INFO_1 jobInfo11 : jobInfo1) {
                        this.printJobInfo(jobInfo11);
                    }
                    break;
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(Win32SpoolMonitor.class.getName());
